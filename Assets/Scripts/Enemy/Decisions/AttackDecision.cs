...
public class AttackDecision : Decision {
    ...
    public override bool Decide(EnemyStateController controller)
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(controller.eyes.position, controller.eyes.TransformDirection(Vector3.right), controller.stats.attackRange, controller.playerLayer);

        Debug.DrawRay(controller.eyes.position, controller.eyes.TransformDirection(Vector3.right) * controller.stats.attackRange, Color.red);
